    ...
    <footer className="bg-gradient-to-b from-[#1a4d2e] to-[#0f2d1a] text-white">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <ul className="space-y-1.5 text-sm">
              <li>
                <a href="https://soilhealth.dac.gov.in/" target="_blank" rel="noopener noreferrer" 
                   className="hover:text-green-400 transition-colors">Soil Health Card Portal</a>
              </li>
              <li>
                <a href="https://agricoop.nic.in/" target="_blank" rel="noopener noreferrer" 
                   className="hover:text-green-400 transition-colors">Ministry of Agriculture</a>
              </li>
              <li>
                <a href="https://www.icar.org.in/" target="_blank" rel="noopener noreferrer" 
                   className="hover:text-green-400 transition-colors">ICAR</a>
              </li>
              <li>
                <a href="https://www.kvks.gov.in/" target="_blank" rel="noopener noreferrer" 
                   className="hover:text-green-400 transition-colors">KVK Portal</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li className="flex items-center gap-1.5">
                ...
                <span>011-23382354</span>
              </li>
              <li className="flex items-center gap-1.5">
                <svg className="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <span>soilhealth@nic.in</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold mb-2 text-green-300">Connect With Us</h3>
            <div className="flex gap-2 mb-3">
              <a href="#" className="bg-white/10 hover:bg-white/20 p-1.5 rounded-full transition-colors" aria-label="Facebook">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
              </a>
              <a href="#" className="bg-white/10 hover:bg-white/20 p-1.5 rounded-full transition-colors" aria-label="Twitter">
              ...
              <a href="#" className="bg-white/10 hover:bg-white/20 p-1.5 rounded-full transition-colors" aria-label="Instagram">
            ...
            <form className="flex gap-1.5">
              <input
                type="email"
                placeholder="Email"
                className="px-2 py-1 rounded bg-white/10 border border-white/20 focus:border-green-400 focus:outline-none text-sm w-full"
              />
              <button
                type="submit"
                className="px-2 py-1 bg-green-600 hover:bg-green-700 rounded text-sm font-medium transition-colors whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
